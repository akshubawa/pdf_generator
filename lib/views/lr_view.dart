...
import 'package:agarwal_packers/services/lr_pdf_service.dart';
...
class _LrViewState extends State<LrView> {
  ...
  uploadQuotationData() async {
    Map<String, dynamic> uploadData = {
      ...
      // "Lorry No.": lorryNumberCOntroller.text,
      
      // "From City": fromCityController.text,
      // "To City": toCityController.text,

      // "Consignor's Name": consignorName,
      // "Consignor's Address": consignorAddress,
      // "Consignor's Phone": consignorPhone,
      // "Consignor's GST No.": consignorGST,
            
      // "Consignee's Name": consigneeName,
      // "Consignee's Address": consigneeAddress,
      // "Consignee's Phone": consigneePhone,
      // "Consignee's GST No.": consigneeGST,
